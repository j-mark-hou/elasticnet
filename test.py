...
def test_compute_mean_std_and_standardize_data():
    ...
    enet_tests.test_compute_mean_std_and_standardize_data(data_input, means, stds)
    # print the output means and stds
    print("now, the computed means and stds (should be around .5 and around .288 respectively")
    print("means", means)
    print("stds", stds)

def test_compute_mean_std_and_standardize_data_time():
    N,D = 100000, 1000
    ...
    enet_tests.test_compute_mean_std_and_standardize_data_time(data_input, D)